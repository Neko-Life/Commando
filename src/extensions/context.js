...
module.exports = class Context {
	constructor(message) {
		...
		this.contextGuild = message.guild ? CommandoGuild.extend(message.guild) : null;
	...
	get member() { return (this.guild && this.guild.members.resolve(this.author.id)) || undefined; }
	...
	respond({ type = 'reply', content, options, lang, fromEdit = false }) {
		...
		if(!('repliedUser' in options.allowedMentions)) options.allowedMentions.repliedUser = false;
